...
namespace DDD_Phonebook.Middlewares;
...
public class ExceptionHandlingMiddleware
{
    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        {
            _logger.LogError(exception, $"Middleware ---> AppException : {exception.Message}");
        ...
        {
            _logger.LogError(exception, $"Middleware ---> Exception : {exception.Message}");
